 ...
 * @return nada
 */
__attribute__(( section(".functions_task023"))) void task02_main(tabla_digitos* td_p,sch_buffer* sc_p)
{
    task_sumatoria(td_p);
 ...
 * 
 */
__attribute__(( section(".functions_task023"))) void task_sumatoria(tabla_digitos* td_p)
{
    /*acumula*/
    static int i=0;
 ...
 * @return nada
 */
__attribute__(( section(".functions_task023"))) void task_02_show_VGA(tabla_digitos* td_p)
{
    ...
    __screen_buffer_printc(16+5+11-i,11,(screen_buffer*) &__VIDEO_VGA_LIN,aux+48);
    }
    ...
    __screen_buffer_printc(8+5+11-i,11,(screen_buffer*) &__VIDEO_VGA_LIN,aux+48);
    }
}

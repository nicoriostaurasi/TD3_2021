...
ISR14_Handler_PF:
    ...
    pusha
    ;Niego el Flag de Paginación para deshabilitar paginacion
;    mov eax, cr0
;    xor eax, 0x80000000
;    mov cr0, eax   
;    xchg bx,bx
    mov eax, cr2                ;Almaceno CR2 como recomienda la PPT
    mov dword [cr2_ram], eax    
...
PF_P:
    ...
    mov ebx, dword [cr2_ram]            ;cargo cr2 en ebx           
    ...
    mov eax, edx                        ;cargo en eax los bits 31-22
    ...
    ;en esta rutina conformo la siguiente expresión:
    ;__PAGE_TABLES_VMA_LIN+0x1000+(0x1000)*(0xFFC00000 & CR2_RAM)>>22
    mov eax, dword [cr2_ram]            ;cargo CR2 en eax
    ...
    xor ecx,ecx
    mov dword ecx,[direccion_carga_local]
;    xchg bx,bx
    push dword(ecx) 
    add ecx,0x1000
    mov dword [direccion_carga_local],ecx
...
FIN_PF:
    ;Habilito Paginación Nuevamente
 ;   mov eax, cr0
 ;   xor eax, 0x80000000
 ;   mov cr0, eax   
    ;Aviso que atendi la interrupcion
    mov al, 0x20        
    out 0x20, al
    popa
    mov edx,0x0E

...
ISR14_Handler_PF:
    ...
    cli                 ;                                     
    push eax            ;guardo eax
    mov eax,cr2         ;analizo el CR2
    and eax, 0x0F       ;rescato los ultimos 4 bits           
    bt eax,0            ;Bit 0 = 1 No presente             
    jc PF_P             ;                              
    bt eax,1            ;Bit 1 = 1 Permisos de Lectura/Escritura         
    jc PF_RW            ;                              
    bt eax,2            ;Bit 2 = 1 Permiso de privilegio
    jc PF_US            ;                              
